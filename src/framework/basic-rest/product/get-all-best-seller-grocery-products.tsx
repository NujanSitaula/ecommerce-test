...
export const fetchBestSellerGroceryProducts = async ({ queryKey }: any) => {
  const { data } = await http.get(
    API_ENDPOINTS.BEST_SELLER_PRODUCTS_DYNAMIC,
  );
  ...
  fetch('http://127.0.0.1:7244/ingest/f0a8cbc8-c4ea-4a4e-8424-57df84ac9e3c', {
    ...
    body: JSON.stringify({
      ...
      hypothesisId: 'H1',
      location:
        'get-all-best-seller-grocery-products.tsx:fetchBestSellerGroceryProducts',
      message: 'Raw best-seller response',
      data: {
        endpoint: API_ENDPOINTS.BEST_SELLER_PRODUCTS_DYNAMIC,
        type: typeof data,
...
export const useBestSellerGroceryProductsQuery = (
  ...
  return useQuery<Product[], Error>({
    queryKey: [API_ENDPOINTS.BEST_SELLER_PRODUCTS_DYNAMIC, options],
