...
export const CheckoutItem: React.FC<{ item: Item }> = ({ item }) => {
  ...
  return (
    <div className="flex items-center py-4 border-b border-border-base ">
      <div className="flex w-16 h-16 border rounded-md border-border-base shrink-0 overflow-hidden">
      ...
      <h6 className="font-normal text-15px text-brand-dark ltr:pl-3 rtl:pr-3 truncate">
