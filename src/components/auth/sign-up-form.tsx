...
export default function SignUpForm({
  ...
  function onSubmit({
    ...
    signUp(
      ...
      {
        onSuccess: () => {
          toast.dismiss('signup-info');
          toast.info(
            t('common:text-verify-your-email') ||
        ...
        onError: (err: any) => {
          ...
          const message =
            (messageFromBackend as string) && messageFromBackend.length
        ...
        <div className="w-full py-6 sm:py-8 px-4 sm:px-8 md:px-6 lg:px-8 xl:px-10 flex flex-col justify-center">
          <div className="text-center mb-6 pt-2.5">
            ...
            <div className="mt-3 mb-1 text-sm text-center sm:text-base text-body">
              ...
              <button
                type="button"
                className="text-sm font-medium ltr:ml-1 rtl:mr-1 sm:text-base text-brand hover:no-underline focus:outline-none"
          ...
          >
            <div className="flex flex-col space-y-4">
              ...
              <PasswordInput
                ...
                lang={lang}
              />
              {/* Phone and country removed per request */}
              ...
              <div className="relative">
                <Button
                  ...
                  variant="formButton"
                >
                  {(t('common:text-register') || 'Register')?.toUpperCase()}
                </Button>
              </div>
            </div>
          </form>
